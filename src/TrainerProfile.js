...
function TrainerProfile() {
  ...
  function handleSubmit(event) {
    ...
    axios
      .put(`http://localhost:9090/prava/user/${userId}`)
      .then((res) => {
        ...
        navigate("/TrainerProfile"); // Navigate to another route if needed
      })
      .catch((err) => {
                  ...
                  <div class="row">
                    <div className="col-4">
                      ...
                      >
                        <div className="card-body">
                          ...
                          <p class="text-primary">{userData.email}</p>
                          <hr></hr>
                    ...
                    <div className="col-8 p-2">
                      <div class=" container-fluid ">
                        ...
                        >
                          <div class="row">
                            <div class="col-2 ms-5 p-2">
                              <img
                                style={{ width: "6rem" }}
                                src="https://cdn-icons-png.freepik.com/256/3688/3688609.png?ga=GA1.1.1354980394.1706180196"
                              />
                            </div>
                            <div class="col-6">
                              <h4 className="card-title">Your Profile </h4>
                              <p>
                                Complete at least 85% of your profile to
                                generate customised resume{" "}
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div
                          className=" col-xl-8 card p-2 mt-4 "
                          style={{ width: "720px" }}
                        >
                          <div className="card-title">
                            <div class="row">
                              ...
                              <button
                                className="btn btn-white col-6"
                                onClick={handleToggleNestedCard}
                              >
                                ...
                                <div className="row">
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                     <b> Experience :</b> <p className="text-success">{userData.years} Yrs</p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                     <b> Interested In :</b>
                                      <p  className="text-success">{userData.typeofmode}</p>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                    <b>  Salary :</b> <p  className="text-success">{userData.currentSalary1}</p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                    <b>  state :</b> <p  className="text-success">{userData.state}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        >
                          <div className="card-title">
                            <div class="row">
                              ...
                              <button
                                className="btn btn-white col-6"
                                onClick={handleToggleNestedCard1}
                              >
                                <FontAwesomeIcon icon={faCaretDown} />
                              </button>
                            </div>
                            ...
                            {showNestedCard1 && (
                              <div className="container-fluid d-flex mt-4">
                                <div className="row">
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                     <b> Role :</b> <p  className="text-success">{userData.selectedOption} </p>
                                    </div>

                                    <div className=" col-6 mb-3">
                                     <b> Interested In :</b>
                                      <p  className="text-success">{userData.proficiency}</p>
                                    </div>
                                  </div>
                                  <div class="row">
                                    <div className=" col-6 mb-3">
                                   <b>   Salary : </b><p  className="text-success">{userData.currentSalary1}</p>
                                    ...
                                    <div className=" col-6 mb-3">
                                    <b>  Address :</b> <p  className="text-success">{userData.state}</p>
                                    </div>
                                  </div>
                                </div>
                              </div>
                        ...
                        >
                          <div className="card-title">
                            <div class="row">
                              ...
                              <button
                                className="btn btn-white col-6"
                                onClick={handleToggleNestedCard2}
                              >
                                <FontAwesomeIcon icon={faCaretDown} />
                              </button>
                            </div>
                                ...
                                <div class="row">
                                  <div className=" col-6 mb-3">
                                   <b> Higher Education :</b>
                                    <p  className="text-success">{userData.professional} </p>
                                  </div>

                                  <div className=" col-6 mb-3">
                                  <b>  Description :</b> <p  className="text-success">{userData.description}</p>
                                  </div>
                                </div>
                              </div>
                            )}
                        ...
                        >
                          <div className="card-title">
                            <div class="row">
                              <h5 className="card-title col-6">
                                Personal Achievements & Certifications
                              </h5>
                              <button
                                className="btn btn-white col-6"
                                onClick={handleToggleNestedCard3}
                              >
                                <FontAwesomeIcon icon={faCaretDown} />
                              </button>
                            </div>
                            ...
                            {showNestedCard3 && (
                              <div className="container-fluid d-flex mt-4">
                                <div class="row">
                                  <div className=" col-6 mb-3">
                                  <b>  certifications :</b>
                                    <p  className="text-success">{userData.certifications} </p>
                                  </div>

                                  <div className=" col-6 mb-3">
                                  <b>  Statement :</b> <p  className="text-success">{userData.statement}</p>
                                  </div>
                                </div>
                              </div>
                            )}
                        ...
                        >
                          <div className="card-title">
                            <div class="row">
                              ...
                              <button
                                className="btn btn-white col-6"
                                onClick={handleToggleNestedCard4}
                              >
                                <FontAwesomeIcon icon={faCaretDown} />
                              </button>
                            </div>
                            ...
                            {showNestedCard4 && (
                              <div className="container-fluid d-flex mt-4">
                                <div class="row">
                                  ...
                                  <div className=" col-6 mb-3">
                                  <b>  Interested In :</b>
                                    <p  className="text-success">{userData.selectOption}</p>
                                  </div>
                                </div>
                              </div>
                            )}
